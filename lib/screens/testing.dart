...
class _FollowUpsState extends State<FollowUps> {
  ...
  void _updatePaymentStatus(String docId, String method) async {
    await _firestore
        .collection(db)
        .doc(docId)
        .update({'paymentStatus': 'paid', 'paymentMethod': method});
    refreshData();
  }

  // Future<void> _showConfirmationDialog(
  //     BuildContext context, String docId, var data) async {
  ...
  //             onPressed: () {
  //               _updatePaymentStatus(docId, "Cash");
  //               addEntryToTodaysTally(
  //                   data['id'],
  //                   data['data']['name'],
  //                   data['data']['charges'].isNotEmpty
  //                       ? data['data']['charges'].last.toString()
  //                       : 'No charges',
  //                   data['data']['medicines'].isNotEmpty
  //                       ? data['data']['medicines'].last.keys.toString()
  //                       : 'NA',
  ...
  //             onPressed: () {
  //               _updatePaymentStatus(docId, "Online");
  //               addEntryToTodaysTally(
  //                   data['id'],
  //                   data['data']['name'],
  //                   data['data']['charges'].isNotEmpty
          ...
          children: [
            Padding(
              padding: EdgeInsets.only(
                  top: headings2 * 2, left: headings2, right: headings2),
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      navv.pageController.jumpToPage(3);
                    },
                    child: Row(
                      children: [
                        Text(
                      ...
                      child: DataTable(
                        ...
                        rows: _filteredData.map((patientData) {
                          ...
                          return DataRow(cells: [
                            ...
                            DataCell(Text(
                              patient['courseSuggested'].toString(),
                              style: GoogleFonts.exo2(
                                  color: Colors.black, fontSize: headings3),
                            )),
                            DataCell(Text(
